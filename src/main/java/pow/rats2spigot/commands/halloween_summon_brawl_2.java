...
public class halloween_summon_brawl_2 implements CommandExecutor {
    private final MainManager mainManager;

    public halloween_summon_brawl_2(MainManager mainManager) {
        this.mainManager = mainManager;
        Objects.requireNonNull(mainManager.getCommand("halloween_summon_brawl_2")).setExecutor(this);
    }
