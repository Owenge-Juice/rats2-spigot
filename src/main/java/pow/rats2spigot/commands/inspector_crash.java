...
public class inspector_crash implements CommandExecutor {
    private final MainManager mainManager;

    public inspector_crash(MainManager mainManager) {
        this.mainManager = mainManager;
        Objects.requireNonNull(mainManager.getCommand("inspector_crash")).setExecutor(this);
    }
    ...
    public boolean onCommand(CommandSender commandSender, Command command, String s, String[] strings) {
        ...
        for(Player playerScanned : mainManager.getWorld().getPlayers()){
                playerScanned.playSound(playerScanned,"rats2:powevents.sound.inspector_crash", SoundCategory.VOICE,1,1);
        }
